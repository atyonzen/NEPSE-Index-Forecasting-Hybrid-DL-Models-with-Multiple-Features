...
def train_model(model_name='lstm', tuner=hb_tuner_lstm):
    ...
    csv_file_path = f'hyper_model/best_model/best_{model_name}_model_history.csv'
    ...
    csv_logger = keras.callbacks.CSVLogger(filename=csv_file_path, separator=',', append=False)
    ...
    model_path = f'hyper_model/best_model/best_{model_name}_model.keras'
